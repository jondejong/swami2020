...
insert into week(id, number, ready, complete)
values ('7cbdd6bf-7545-4091-a227-4f29450632d7', 1, false, false);

insert into week(id, number, ready, complete)
values ('3d581ea2-b3c8-4576-87df-683eb4abd8ee', 2, false, false);

insert into week(id, number, ready, complete)
values ('232a5c59-8a23-4917-a4cf-7f0d367cb4ad', 3, false, false);

insert into week(id, number, ready, complete)
values ('39cdeea0-9e2b-4f61-90ad-e968cc25a799', 4, false, false);

insert into week(id, number, ready, complete)
values ('a74adaa6-3098-4fcf-b4d9-9b04c64d9bd0', 5, false, false);
